...
class ChatUIConfiguration: ATCUIGenericConfigurationProtocol {
    ...
    let mainThemeForegroundColor: UIColor = UIColor(named: "#3068CC")
    let mainTextColor: UIColor = UIColor(named: "#000000")
    let mainSubtextColor: UIColor = UIColor(named: "#7e7e7e")
    let statusBarStyle: UIStatusBarStyle = .default
    let hairlineColor: UIColor = UIColor(named: "#d6d6d6")
